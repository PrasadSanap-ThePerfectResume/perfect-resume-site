...
public class AppConstants {
    ...
    public static final String OTP_NOT_SEND = "YOUR OTP NOT SEND";
    public static final String OTP_NOT_VERIFIED = "YOUR OTP NOT VERIFIED";
    public static final String OTP_SEND = "YOUR OTP IS SEND";
    ...
    public static final String SKILL_SAVE = "YOUR SKILL IS SAVE";
    ...
    public static final String LANGUAGE_NOT_SAVE = "YOUR LANGUAGE IS NOT SAVE";
    ...
    //UPDATE MESSAGE
    public static final String EDUCATION_UPDATED = "YOUR EDUCATION IS UPDATED";
    public static final String ADDRESS_UPDATE = "YOUR ADDRESS IS UPDATED";
    public static final String EXPERIENCE_UPDATED = "YOUR EXPERIENCE IS UPDATED";
    ...
    //NOT UPDATE MESSAGE
    public static final String EDUCATION_NOT_UPDATED = "YOUR EDUCATION IS NOT UPDATED";
    public static final String EXPERIENCE_NOT_UPDATED = "YOUR EXPERIENCE IS NOT UPDATED";
